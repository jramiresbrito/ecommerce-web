...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  useEffect(() => {
    if (product && router.pathname.includes('Edit')) {
      ...
      // Get only the Date, without the time: '2021-01-20T:00:00:000Z' ~> '2021-01-20'
      setReleaseDate(product.release_date.split('T')[0]);

      // if sr or sr.id doesn't exists or are null, set 1
  ...
  if (error || systemRequirementsError) {
    toast.error(
      'Ocorreu um erro ao obter as categorias/requisitos de sistema, tente novamente.'
    );
    console.log(error);
  }
            ...
            <Form.Row>
              <Form.Group as={Col} md={6} sm={12} className="p-2">
                ...
                <Form.Control
                  ...
                  onChange={(evt: React.ChangeEvent<HTMLDataElement>) =>
